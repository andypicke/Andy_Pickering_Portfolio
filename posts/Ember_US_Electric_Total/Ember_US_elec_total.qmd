...
df_emis_yearly_UStot %>% 
  ...
  ggtitle("Total CO2 Emssions From Electricity Generation") +
...
@fig-emissions-vs-generation shows a scatterplot of total US yearly emissions vs electricity generation, with the color corresponding to the year. This shows a trend of decreasing emissions over time, even as generation has increased.
